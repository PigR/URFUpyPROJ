...
$(function() {
  $(".btn").click(
    // заполняет карточку товара при её изменении через админку
    // ДОБЫТО КРОВЬЮ И ПОТОМ!
    function() {
      ...
      // ЧТОБЫ ПОЛЯ НЕ ЗАПОЛНИЛИСЬ undefined КОГДА ОТПРАВЛЯЕМ ФОРМУ
      if (title != undefined) {
        document.getElementById('id_-id').setAttribute("value", id_)
        document.getElementById('title-id').setAttribute("value", title)
        document.getElementById('description-id').setAttribute("value", description)
        document.getElementById('price-id').setAttribute("value", price)
        document.getElementById('key-group-id').setAttribute("value", key_group)
      }
    })
});
